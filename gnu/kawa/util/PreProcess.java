...
public class PreProcess
{
  ...
  static final String NO_JAVA6_FEATURES = "-JAVA6 -JAVA7 -JAVA8 -use:java.dyn -use:java.text.Normalizer";
  ...
  static String[] version_features = {
    ...
    "java6compat5", JAVA5_FEATURES+" -JAVA6 -JAVA7 -JAVA8 +JAVA6COMPAT5 +use:java.text.Normalizer -use:java.dyn -Android",
    "java6", JAVA5_FEATURES+" +JAVA6 -JAVA7 -JAVA8 -JAVA6COMPAT5 +use:java.text.Normalizer -use:java.dyn -Android",
    "java7", JAVA5_FEATURES+" +JAVA6 +JAVA7 -JAVA8 -JAVA6COMPAT5 +use:java.text.Normalizer +use:java.dyn -Android",
    "java8", JAVA5_FEATURES+" +JAVA6 +JAVA7 +JAVA8 -JAVA6COMPAT5 +use:java.text.Normalizer +use:java.dyn -Android",
